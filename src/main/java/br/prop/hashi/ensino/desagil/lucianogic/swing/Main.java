package br.prop.hashi.ensino.desagil.lucianogic.swing;
...
import br.prop.hashi.ensino.desagil.lucianogic.swing.view.MainView;
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
            	...
            	// Cria a janela.
            	JFrame frame = new JFrame("Logic Gates");
